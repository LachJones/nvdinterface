...
def build_from_api_response(d: Dict[str, Any]) -> Union[CVSSMetricV2, CVSSMetricV30, CVSSMetricV31, CVSSMetricV40]:
    dat = d.copy()
    ...
    if dat.get("version") == "2.0":
        ...
        raise ValueError(f"Could not find a valid version for the CVSS metric.\ndata:\n{dat}")
